...
<%
		...
		String n1 = request.getParameter("UserPhone1#");
		String n2 = request.getParameter("UserPhone2#");
		String n3 = request.getParameter("UserPhone3#");
		String newPhoneNum = n1 + "-" + n2 + "-" + n3;
