...
<form method="post" action="newUser.jsp" style="border:1px solid #ccc">
  <div class="container">
    ...
    (<input type="text" size="3" placeholder="123" pattern="[0-9]{3}" name="UserPhone#" required>) <input type="text" size="3" placeholder="456" pattern="[0-9]{3}" name="UserPhone#" required> - <input type="text" size="4" placeholder="7890" pattern="[0-9]{4}" name="UserPhone#" required>
    <br>
