...
<body>
	...
	<!-- Page content -->
	<div class="content">
<% String keywords = request.getParameter("QuestionSearch"); %>
			...
			<table border="2">
				...
				<%
					try {
						...
						String query = "SELECT * FROM Questions WHERE Question LIKE '%" + keywords + "%'";
				...
				%>
				<tr>
					<td><%=rs.getString("QuestionUserID")%></td>
					<td><%=rs.getDate("DatePosted")%></td>
