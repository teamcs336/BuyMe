	...
	%>
		...
		<table>
			...
			while(expAuc.next()){
				...
				if(!minBid.equals("None") && curBid.compareTo(minBid) > 0) out.println("<td style=\"padding-left: 100px\">" + expAuc.getString("HighestBidderID") + "</td>");
        ...
        <form action="createAuction.jsp" method="GET">
            ...
            <br>
            Input end time (24hr format): <input style="margin-top: 5px" type="time" name="auctionEndTime" placeholder="hh:mm:ss" required>
            <br>
