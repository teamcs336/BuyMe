...
<body>
	...
	<% 
		...
		String crid = "SELECT RepID FROM CustomerRep WHERE RepID = " + uid;
		Statement getreps = con.createStatement();
		ResultSet crrs = getreps.executeQuery(crid);
		
		if(uid != null && uid.equals("1")){
			out.println("<br><b>Hello Admin</b>");
			out.println("<br><br><a href=\"AdminControl.jsp\">[Admin Controls]</a>");
		}
		else if(crrs.next()){
			out.println("<br><b>Hello Customer Representative</b>");
			
			out.println("<br><br><a href=\"CustRepControl.jsp\">[Customer Representative Controls]</a>");
		}
